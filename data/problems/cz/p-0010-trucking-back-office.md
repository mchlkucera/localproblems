...
process:
  ...
  - who: The office
    today: 'Handles the delivery note and the CMR consignment note over phones, e-mail and old dispatch software'
    known: documented
    cites: [2]
    reenters: false
    change: changes
    after: 'Software reads the delivered load''s own delivery note and CMR'
  - who: The office
    today: 'Invoices the load over phones, e-mail and old dispatch software'
    known: documented
    cites: [2]
    change: changes
...
Road freight is one of Czechia's biggest sectors: roughly 40,000 haulier firms, most under ten trucks [S2]. Their dispatch, documents and invoicing run on phones, e-mail and old dispatch software — a dispatcher arranging loads by phone, delivery notes, the CMR (the consignment note every cross-border truck shipment carries) and invoices handled the same way [S2]. Margins are thin, drivers scarce [S2]. The work is repetitive, document-heavy, Czech — the shape AI phone agents and document ingestion now handle [S1].
...
4. Pitch two factoring providers (firms that buy invoices for early cash) that serve small hauliers as your distribution channel. Cleaner documents speed their own work; a per-truck bundle gives them a reason to sell it for you.
