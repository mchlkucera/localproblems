...
Why now: "access by design" is a product-engineering requirement, not a policy — it must ship in firmware and cloud backends of products entering the market in weeks. The switching-charge wave forces every Czech SaaS to build export/portability paths that most have deferred indefinitely.

Who pays: device manufacturers buying data-API layers, consent management and contract remediation; SaaS providers buying exit/portability tooling; both segments buying legal-technical gap analyses. The overlap with Machinery Regulation work (p-0014) means industrial manufacturers face compounding product-compliance stacks with the same thin engineering teams.

Existing non-solutions: law-firm advisories and one-off consulting; some enterprise IoT platforms advertise Data Act modules, but nothing verified for the Czech mid-market OEM segment (gap unchecked, scored 0).
