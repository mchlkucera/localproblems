...
- name: Sloneek
  ...
  evidence: 'funding at Series A or later: $6M Series A in June 2026 (Orbit Capital, Venture
    to Future Fund). Its HR system markets pay-band creation and management, automated data
    collection for reporting, and analysis of pay differences by gender or role; Sloneek s.r.o.
    has traded since 2019.'
- name: TREXIMA (Manažer odměňování)
  ...
  competes: direct
  maturity: established
  evidence: 'named customers: the labour ministry, for which TREXIMA runs the state ISPV
    earnings survey — the same benchmark data Manažer odměňování sells back to employers. The
    product is analytical job evaluation, twice-yearly wage benchmarking, an explicit Gender
    Pay Gap report and an Analýza systému odměňování module, at 79,000 CZK a year on a
    three-year fixed price. TREXIMA, spol. s r.o. has traded since November 1991. Two things it
    does not have, stated so the claim can be checked: its own Naši klienti panel is empty, and
    it holds no public contract in the Czech contracts register. What the product stops short of
    is the directive''s prescribed filing — quartile bands, mean and median gaps on variable
    pay, the joint assessment.'
- name: Nakladatelství FORUM (Spolehlivé řízení rovného odměňování)
  ...
  competes: direct
  maturity: early
  evidence: 'a web application at 8,499 CZK a year ex-VAT that groups employees by job value,
    ...
    FORUM s.r.o. has traded since 2004, but this product is sold explicitly against Czech rules
    taking effect on 1 January 2027 and cannot have been on sale for three years.'
sources:
- type: regulation
