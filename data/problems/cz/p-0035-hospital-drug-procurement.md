...
- type: tender
  ...
  note: 'ted-461139-2026 represents 38 drug-object dynamic-purchasing notices from Všeobecná
    ...
    Corrected 2026-09-19: on the 2026-09-19 ladder public money nearby earns no point, and these
    notices buy medicines, not the price comparison, so money is 0, not 1.'
  date: '2026-07-06'
...
- type: regulation
  ...
  note: 'reg-mzd-289-2025-pojisteni, committed 2026-08-14. THE LEDGER TITLE HIDES THIS
    ...
    Corrected 2026-09-19: the deadline sub-score is retired, and the 2026-09-18 rewrite read the
    amending article at the primary (art. I point 226, in force 1 Jan 2026). On the 2026-09-19
    ladder this is enacted and close, but it gives the power to the insurers, and a hospital loses
    reimbursement only once an insurer has tendered a drug centrally. No such tender is on file,
    so it is a duty on someone else that reaches the buyer indirectly: urgency 1, not 2 or 3.'
  date: '2026-01-01'
...
- type: regulation
  ...
  note: 'reg-cz-cenovy-vymer-1-2026-olzp: issued 24 October 2025, published in ministry
    ...
    Corrected 2026-09-19: the deadline sub-score is retired. A price ruling on the margin sellers
    may charge puts no duty on a hospital, so it scores 0 on the 2026-09-19 ladder; dims is set
    empty and urgency rests on [S5] alone.'
  date: '2026-01-01'
...
- type: complaint
  ...
  note: 'civic-vzp-centrove-leky-bonusy, 10 March 2025. The payer''s own account, and the
    ...
    Corrected 2026-09-19: on the 2026-09-19 ladder the same distinction puts money at 0.'
  date: '2025-03-10'
...
- type: complaint
  ...
  note: 'civic-mz-spolecne-nakupy-fn-2026, 29 July 2026. Signatories: Motol, Královské Vinohrady,
    ...
    Corrected 2026-09-19: the freshness sub-score is retired and backs nothing; this stays a
    demand source.'
  date: '2026-07-29'
...
- type: gap-check
  ...
  expires: '2026-12-02'
- type: regulation
  name: "Draft reimbursement decree for 2027 — centre drugs bought up to 7bn CZK below the billed price at best practice"
  gist: "the ministry's 2027 draft"
  why: "The health ministry's draft reimbursement decree for 2027, open for comment until 23 September 2026, compares what hospitals paid for specialist-centre drugs with what they billed, finds their purchasing departments differ widely, and cuts insurers' payments for those drugs by a price-discount index."
  url: https://www.odok.cz/portal/services/download/attachment/KORNDXRKFEMB/
  note: 'reg-uhradova-2027-centrove-leky-slevy (reg-scan, 2026-09-19); the same decree is
    veklep-ALBSDXRFYLM6 on the scripted VeKLEP feed (odok.gov.cz/portal/veklep/material/ALBSDXRFYLM6/),
    authorised 2026-09-09, comments due 2026-09-23. The URL is the explanatory memorandum; payload
    data/raw/2026-09-19/regulation/veklep/zd_ALBSDXRFYLM6.txt, read 2026-09-19. STATUS: DRAFT,
    not issued; the effect clause reads "nabývá účinnosti dnem 1. ledna 2027". Read from the memo:
    the centre-drug mechanism "nově nastavený ... z roku 2026" continues, so the 2026 decree
    (reg-mzd-uhradova-432-2025) already applies it; per diagnostic group the gap between purchase
    cost and reported price sets an "index cenové slevy" applied to the reported volume, so
    "poskytovatel dostane uhrazenu nižší částku". A table per group gives the weighted-average and
    the best-practice ratio of purchase cost to reported price (digestive system 84.0 % against
    63 %, rheumatology 78.1 % against 70 %); "existuje významná heterogenita v efektivitě obchodních
    oddělení nemocnic"; the weighted-average gap is about 4bn CZK, "až 7 mld. Kč" if every provider
    bought at best-practice prices; the 2027 indices split the average gap 55:45 in insurers'' favour,
    a direct saving of 2.2bn CZK, against 1.5bn from the negotiators'' joint proposal; out-of-hospital
    specialists are told to buy cheaper, "samostatně, společně jako skupina ... nebo ve spolupráci s
    nemocnicemi". WHY dims [demand]: this is the state measuring, from purchase data it collected,
    the price dispersion the problem is about. NOT URGENCY: a draft fails REAL, and even enacted the
    index changes what insurers pay and puts no duty on a hospital to act (SCORING.md rung 0). NOT
    MONEY: savings estimates on drug spend, not a price for this job. The ministry''s purchase-cost
    data is not a product sold to hospitals and moves no gap.'
  date: '2027-01-01'
...
- type: tender
  ...
  dims: []
- type: tender
  name: "TED — Bulovka and Královské Vinohrady, 28 medicines bought together"
  gist: "the 28-lot joint purchase"
  why: "Two Prague teaching hospitals opened one purchase covering 28 medicines, one active substance to a lot, estimated together at about 2.5bn CZK."
  url: https://ted.europa.eu/en/notice/-/detail/646876-2026
  note: 'ted-646876-2026, read 2026-09-21 from the TED search API. Contract notice
    (cn-standard), open procedure, published 21 Sep 2026, "Dodávky LP - společný nákup",
    buyers Fakultní nemocnice Bulovka and Fakultní nemocnice Královské Vinohrady, bids due
    20 Oct 2026. 28 lots, each for continuous supplies of one active substance:
    darolutamide, upadacitinib, ustekinumab, talazoparib, atezolizumab, guselkumab,
    sacituzumab govitecan, faricimab, panitumumab, ipilimumab, remdesivir, vedolizumab,
    amivantamab, deucravacitinib, pertuzumab, mirikizumab, baricitinib, avelumab,
    binimetinib, sotorasib, trastuzumab emtansine, dostarlimab, apalutamide, cetuximab,
    dupilumab, secukinumab, cabozantinib and bimekizumab. Total value on the notice
    2,509,611,143.46 CZK; the 28 per-lot estimates are published but are not paired with
    their substances here, because the API returns the two lists separately and the pairing
    would be read off their order. Both buyers signed the ministry''s July 2026 memorandum
    on joint buying [S12]. CONTEXT, dims empty: it buys medicines, not a price comparison,
    so it earns no money point; demand is already 2 on the state''s own findings
    [S7,S9,S19]. It matters because it is the pooling this problem''s answer is measured
    against, and because two other signatories bought two of these same substances alone in
    the same weeks [S25,S26].'
  date: '2026-09-21'
  signal: ted-646876-2026
  dims: []
- type: tender
  name: "TED — St Anne's in Brno buys guselkumab on its own"
  gist: "one hospital, one substance"
  why: "A Brno teaching hospital awarded a guselkumab contract by itself five days before two Prague hospitals put the same substance into their joint purchase."
  url: https://ted.europa.eu/en/notice/-/detail/650080-2026
  note: 'ted-650080-2026, read 2026-09-21 from the TED search API. Award notice
    (can-standard), "L04AC16 GUSELKUMAB", buyer Fakultní nemocnice u sv. Anny v Brně,
    supplier Janssen-Cilag s.r.o., procedure oth-single, contract concluded 16 Sep 2026,
    result value 27,890,665.8 CZK against an estimate of 26,582,249 CZK. St Anne''s is one
    of the six hospitals that signed the ministry''s July 2026 memorandum on joint buying
    [S12], and guselkumab is one of the 28 lots in the Bulovka and Královské Vinohrady
    joint purchase published five days later [S24]. CONTEXT, dims empty: the money buys the
    medicine, not a price comparison, and it is not restated as a price receipt for that
    reason. NOT CLAIMED: nothing here shows either buyer paid too much — the volumes behind
    the two procedures are not on file.'
  date: '2026-09-16'
  signal: ted-650080-2026
  dims: []
- type: tender
  name: "TED — Brno university hospital tenders ustekinumab on its own"
  gist: "a second substance bought twice"
  why: "Brno's university hospital opened its own ustekinumab tender in the same week that two Prague hospitals put the same substance into their joint purchase."
  url: https://ted.europa.eu/en/notice/-/detail/649047-2026
  note: 'ted-649047-2026, read 2026-09-21 from the TED search API. Contract notice
    (cn-standard), open procedure, "Léčivé přípravky s účinnou látkou USTEKINUMAB II.",
    buyer Fakultní nemocnice Brno, two lots for a framework purchase contract, estimated
    124,710,580 CZK and 13,431,010 CZK, 138,141,590 CZK together, bids due 19 Oct 2026. The
    "II." in the title marks a second procedure. Fakultní nemocnice Brno is one of the six
    signatories of the ministry''s July 2026 memorandum [S12], and ustekinumab is one of
    the 28 lots in the joint purchase published two days later [S24]. CONTEXT, dims empty:
    it buys medicines, not the comparison this problem is about.'
  date: '2026-09-21'
  signal: ted-649047-2026
  dims: []
- type: tender
  name: "TED — Krajská zdravotní's own standing system for medicines"
  gist: "a regional group's own drug system"
  why: "A regional hospital group runs its own standing purchasing system for medicines and awarded a two-year framework for a single drug under it."
  url: https://ted.europa.eu/en/notice/-/detail/647026-2026
  note: 'ted-647026-2026, read 2026-09-21 from the TED search API. Award notice
    (can-standard), restricted procedure, "Dynamický nákupní systém na dodávky léčivých
    přípravků - 5123", buyer Krajská zdravotní, a.s. The lot buys continuous supplies of
    fremanezumab for the buyer''s own care, delivered into the pharmacies of its individual
    branch hospitals, under a framework agreement with one selected supplier for 24 months;
    lot estimate 40,573,000 CZK. The notice states a total value of 16,000,000,000 CZK,
    which is the purchasing system''s own stated value and not money spent, the same
...
- In September 2026 the health ministry's draft payment rules for 2027 found that hospitals' purchasing departments differ widely in what they save on specialist-centre drugs [S19].
- On average hospitals buy those drugs about 4bn CZK below the price they bill the insurers; if every hospital bought as cheaply as the best, the gap would be up to 7bn CZK [S19].
...
Since 1 January 2026 three rules have changed, and in July the health ministry agreed to try joint buying again:
...
- The insurer then pays the hospital the price its tender reached, and does not pay a hospital that bought the drug outside that tender [S5]. No insurer is known to have run such a tender yet.
...
- Since 2026 insurers also pay hospitals less for specialist-centre drugs, by an index read off the gap between what hospitals paid and what they billed [S19].
- A draft decree for 2027, open for comment until 23 September 2026, keeps that index with new values, saving insurers 2.2bn CZK, and tells specialists outside hospitals to buy cheaper, alone, in groups or with hospitals [S19].
...
4. Take the comparison to the health insurers, who may now buy drugs for specialist centres in one tender on the hospitals' behalf. The national insurer argued for that power with its own numbers, and the law now gives it; see [Why now](#why-now). An insurer planning such a tender will want to know what each hospital pays today, and a hospital that keeps buying such a drug alone is not reimbursed, so both sides need the same picture. Hospitals already have a reason of their own: insurers now pay less for those drugs by an index read off what hospitals paid, so a hospital that pays more than its peers keeps less, as the same section shows. The health ministry's new joint-buying project with the big university hospitals is a second buyer to show it to, under the same section.
