...
| `/about` | brief static page: the vision, the four evidence streams (with live counts), and the register's rules — sourced claims, no estimates, printed corrections, de-ranking. |
