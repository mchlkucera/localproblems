...
- type: regulation
  ...
  dims: []
- type: tender
  name: "TED — Veltrusy tenders its town solar a second time"
  gist: "a fifth town's second call"
  why: "The town of Veltrusy published its tender for solar panels and batteries on four town buildings a second time in September 2026, after a first call in June."
  url: https://ted.europa.eu/en/notice/-/detail/635308-2026
  note: 'ted-635308-2026, contract notice published 15 Sep 2026, XML read 2026-09-19: Město
    Veltrusy (IČO 00237272), "FVE města Veltrusy - 2.výzva", estimated 4,900,000 CZK, bids due 19 Oct
    2026, lowest price wins; PV with batteries on the cultural centre, medical house, town hall and
  ...
  dims: []
- type: tender
  name: "TED — Moravian-Silesian region's pooled solar tender"
  gist: "one region, six lots, three delays"
  why: "The Moravian-Silesian region put solar for buildings of the organisations it runs into one six-part tender, then moved the bid deadline three times while clarifying the tender documents."
  url: https://ted.europa.eu/en/notice/-/detail/641475-2026
  note: 'ted-641475-2026, change notice published 17 Sep 2026, XML read 2026-09-19: Moravskoslezský
    kraj (IČO 70890692), "Instalace FVE na krajských organizacích", "instalace fotovoltaických
    elektráren na budovách organizací zřizovaných Moravskoslezským krajem", divided into 6 parts,
    estimated 25,624,681.60 CZK in all. The same procedure (one ContractFolderID) was re-notified
