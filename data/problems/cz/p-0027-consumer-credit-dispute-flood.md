...
id: p-0027
region: cz
title: 'Czech lenders now fight more than 4 times as many loan complaints as in 2023'
brief: 'Borrowers say lenders didn''t check they could repay, and take them to the state''s financial arbiter [S1]. It got 12,050 complaints last year, mostly against lenders, and cases drag on for months [S1].'
solution: 'Build case software for lenders that pulls the loan file, drafts the reply to the arbiter and tracks deadlines.'
good_for: 'Someone who''d like to build software for banks and lenders.'
