...
The European Accessibility Act became Czech law (zákon č. 424/2023 Sb.) in June 2025, with ČOI among the designated supervisory bodies [S1]. In scope: e-shops, banks, transport ticketing, e-book sellers and consumer-device makers — with an exemption only for micro-enterprises providing services [S1].

Why now: the obligation is live [S1]. Merchant-facing FAQ content and industry confusion about scope show the market still discovering it [S2].
