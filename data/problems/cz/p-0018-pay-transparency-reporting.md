...
- name: TREXIMA (Manažer odměňování)
  ...
  since: 1991
  status: early
  evidence: 'analytical job evaluation, twice-yearly wage benchmarking, an explicit Gender Pay
    Gap report and an Analýza systému odměňování module, at 79,000 CZK a year on a three-year
    fixed price. TREXIMA, spol. s r.o. has traded since 1991 and runs the ISPV earnings survey
    for MPSV, but its own Naši klienti panel is empty and no limb of the established test is
    on file.'
