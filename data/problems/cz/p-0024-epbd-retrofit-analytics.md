...
Updated 2026-08-13: the money side is now receipted from the EPC market — 11 public buyers awarded ~€58M of energy-performance contracting between June and August 2026, including three Plzeň-region hospitals in a single week [S4]. That is exactly the spend a portfolio-analytics layer front-ends (which buildings, in what order, at what capex), receipted as adjacent tenders (money 1) [S4]. The EPC supplier side (ENESA, ČEZ ESCO, MVV and the APES ecosystem) is mature — the unoccupied position remains the owner-side analytics product, not retrofit delivery.
