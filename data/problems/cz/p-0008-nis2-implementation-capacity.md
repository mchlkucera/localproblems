...
Existing non-solutions: fragmented security consultancies and MSPs [S2]. Productised offers are emerging at the smallest tier — Lexnova Energy's ~91k CZK "NIS 2 package" sells off the shelf, repeatedly [S7] — but no structured check of the Czech field at the 6,000-entity scale has been run, so no gap is claimed here.
...
Who pays: the roughly 6,000 regulated entities themselves — compelled by law, not persuaded [S1,S13]. Public buyers alone placed ~77 cyber-security awards worth ~€33M in June–August 2026 [S7], from Motol's ~€6.1M [S3] and Prague's ~€5.3M SIEM [S4] down to a town of 7,000 [S6], plus a ~€99.6M IROP subsidy pot [S9] towns pay consultants just to enter [S8]. Tooling sells at €500–6,000 per firm a year — Reglyze from €490, Secfix ~€500 a month, Vanta and Drata near $7,500 [S14]; the smallest Czech buyers already pay ~€3,700 a package [S7]. A €3,000-a-year product bought by a quarter of the 6,000 is ~€4.5M a year — a conservative floor before the implementation services where the €33M sits [S14]. European cybersecurity spend: ~$70 billion in 2026, growing ~11% a year on NIS2 and DORA [S15].

Solved elsewhere: Secfix (Berlin, €10.2M Series A) sells compliance automation to hundreds of SMBs across 15+ European countries [S11]; Copla (Vilnius, €6M Series A) covers NIS2, DORA and ISO 27001 [S12] — small teams already package exactly this obligation, neither on record in Czechia.

## First moves

1. Sell where buying is receipted: social-care institutions and towns around the 7,000-inhabitant tier. A care home bought a ~91k CZK "NIS 2 package" off the shelf, with a repeat order weeks later, and Týn nad Vltavou paid just to learn its scope [S7]; Český Brod signed ~9M CZK, and 341 cyber contracts sit in the registry since June [S6].
...
4. Close the record's own missing dimension before committing: run the structured check on Czech NIS2 offerings at the 6,000-entity scale — Lexnova Energy's repeat packages and Institut kybernetické bezpečnosti's scope-analysis product show the supply side is no longer only consulting [S7], so verify whether the small-entity tier is genuinely underserved or merely early.
...
6. Competition on file: Lexnova Energy (repeat productised packages), Institut kybernetické bezpečnosti (scope analysis), enovation (subsidy applications) [S7,S8], plus the fragmented consultancy and MSP field; abroad, Secfix [S11] and Copla [S12] prove the compliance-automation model.
