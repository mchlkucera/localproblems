...
1. Sell to the networks, not to the independents. The advisory networks — the Broker Consulting and Partners ecosystems and their peers — carry hundreds of tied agents each, and it is the network's compliance officer who can spread one subscription across all of them [S1,S3]. That is the shape Saturn sells in Britain: the firm buys, its advisers use it [S1].
2. Build the MiFID II half, and plug into the anti-money-laundering half rather than rebuild it. AML Proof already sells client identification, sanctions and politically-exposed-person screening, beneficial-owner verification, internal policies and reporting to the financial intelligence unit, self-serve from 25 CZK a credit [S4]. What no Czech product covers is the suitability questionnaire, the record of the advice meeting, product-governance records, tied-agent oversight and the reporting the Czech central bank requires [S4].
3. Open with the date. The EU anti-money-laundering regulation 2024/1624 applies directly from 10 July 2027, replacing much of the Czech regime with one rulebook under a new EU supervisor, and every firm in scope has to rewrite its client due diligence and internal policies before then [S2]. Ask what they plan to do about it: today the answer is a consultant and a Word template [S1,S3].
4. Watch Broker Trust. It has run the Bety 2.0 and BT Invest platform for its own tied advisers since March 2001, and it is the closest thing on the market to what is missing — but it is in-house tooling for one broker network, not something an intermediary outside that network can buy at any price [S4]. The day it goes on sale, this opening closes.
