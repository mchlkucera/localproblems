// /lab/modern/signals — one evidence ledger, one page of it, in the modern
...
//
// DESIGN: the front page's grid (../front.css). The rail names the month the
...
import { DESCRIPTIONS, SOURCE_LABELS, TITLES } from "../../../../lib/ledger";
import { categoryLabel, countryName, euro } from "../../../../lib/format";
import { CORRECTIONS_MAILTO } from "../../../../lib/chrome";
import { fmtDate } from "../sources";
import { TopBar } from "../bar";

export const enabled = () => process.env.LP_ADMIN === "1";

/** "Funded", from "Funded — companies founded and financed". */
export const shortTitle = (type: EvidenceType) => TITLES[type].split(" — ")[0];

export const BASE = "/lab/modern/signals";
