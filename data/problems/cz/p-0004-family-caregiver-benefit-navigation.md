...
id: p-0004
region: cz
title: 'About 100,000 Czech family carers can''t work full-time, and one assessment sets their relative''s allowance'
brief: 'One grade higher can pay an adult over 4 times as much a month [S7]. Free advisers help families appeal, but no Czech company handles the whole claim for a fee [S6,S9].'
solution: 'Build an online service that files a family''s care-allowance claim, prepares them for the assessment and runs any appeal.'
good_for: 'Someone who''d like to work with families caring for a relative.'
