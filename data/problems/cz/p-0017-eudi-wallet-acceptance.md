...
Czechia must offer an EU Digital Identity Wallet to citizens and businesses by the end of 2026 [S1,S2], and within 36 months of the December 2024 implementing acts — i.e. during 2027 — banks, telcos, large platforms and other regulated businesses must accept it wherever strong user authentication is required [S1]. The state's deadline creates the private sector's problem: every Czech relying party needs wallet-acceptance flows [S1], and the reg-eidas2 signal notes that banks, utilities, e-shops with KYC obligations and municipalities currently have no integration path beyond following eDoklady's evolution.
