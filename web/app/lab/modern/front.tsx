// /lab/modern — the front page, shared by its two STATIC routes: ./page.tsx
// (/lab/modern, by opportunity) and ./by-category/page.tsx
// (/lab/modern/by-category). Neither reads `searchParams`, so both render at
...
const GROUPINGS = [
  { key: "opportunity", label: "By opportunity", href: "/lab/modern" },
  { key: "category", label: "By category", href: "/lab/modern/by-category" },
] as const;
