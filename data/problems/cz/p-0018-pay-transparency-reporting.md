...
id: p-0018
region: cz
title: 'Czech employers with 150+ staff would have to report their gender pay gap. The draft law is planned for January.'
brief: 'Czechia is already late on these EU rules [S1]. Under the draft, every employer would put pay ranges in job ads, and the first pay-gap reports would be due in April 2028 [S1].'
...
good_for: 'Someone who''d like to work with HR and payroll teams.'
