// /lab/parts/figures/kit — citation plumbing, borrowed read-only from the record
...
import { signalHref, type ProblemSource } from "../../../../../lib/data";
import { cite, newCtx, type CiteCtx } from "../../../modern/cite";
import { inline } from "../../../modern/prose";
import { labSource } from "../../../modern/sources";
