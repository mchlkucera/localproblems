...
Who pays: hospital groups and kraje (the owners) — today via SI tenders, which is exactly the opportunity for consultancies and dev shops; longer-term, a productized interop/ESB layer with Czech NIS integrations (Stapro FONS/TransMISE, ICZ eMEDOCS) [S8] could compress these €3-8M projects into licensing deals [S1,S2,S3].
