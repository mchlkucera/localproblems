...
id: p-0024
region: cz
title: 'Czech public bodies awarded €58M in energy-saving renovation contracts this summer'
brief: 'Hospitals and towns pay firms to renovate from the energy saved, but that buys the work, not a ranking of which building comes first [S4]. Czechia is late on new EU building rules [S3].'
solution: 'Build software that reads an owner''s energy data and ranks which building to renovate first, and at what cost.'
good_for: 'Someone who''d like to work with hospitals and towns, through public tenders.'
