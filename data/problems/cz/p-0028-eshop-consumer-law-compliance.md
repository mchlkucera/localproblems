...
brief: 'From 1 January 2027 every Czech e-shop must show a button for withdrawing from a contract, and a shop without one commits an offence [S19]. Inspectors caught 639 e-shops last year, with fines averaging about 20,000 CZK [S1].'
...
- name: Hlídač Slev (JARABOT)
  ...
  evidence: It sells reference-price rewriting for the 30-day discount rule, keeping three years
    of history a shop can export for the trade inspectorate [S8,S10]. That is a compliance duty
    next door, not this one. It does not check the information a checkout must show, the order
    button or "eco" claims, and the sweep of 606 add-ons found none that does [S10]. Its Shoptet
    listing carries ratings from January 2023, so the add-on has sold since then, although the company now behind it, JARABOT s.r.o., was registered
...
- name: Slevy správně (Cenový automat)
  ...
  evidence: It sells the same reference-price correction for the 30-day rule, at a flat 200 Kč
    a month [S8,S10]. Like the other discount add-on, it sells that duty next door and does
    not check a shop's checkout information, order button or "eco" claims [S10]. The product
    dates to the 6 Jan 2023 rule it corrects for, it publishes no count of shops using it, and its four Shoptet ratings average 4.0 [S10]. It is also sold on
...
- type: regulation
  ...
  note: 'reg-green-claims-ecgt: Empowering Consumers for the Green Transition Directive (2024/825)
    ...
    ladder a directive awaiting transposition fails REAL: the Czech bill (S13) has not passed, so
    27 Sep 2026 binds member states, not shops. It backs urgency 1. The fines under the existing
    act are the status quo, not a new dated duty.'
  date: '2026-09-27'
...
- type: price
  ...
  note: 'Price receipt lifted from the 2026-08-20 gap re-check already on this ledger, which
    ...
    Rescored 2026-09-19: left untagged, by the owner-approved rule for this record that a price
    counts only if it buys this job. It buys discount-labelling compliance, a duty the scan in
    solution does not cover (checkout information, order buttons, eco claims), so it is not a
    receipt for this job and backs no score.'
  date: '2026-08-20'
...
- type: regulation
  ...
  note: 'reg-odstoupit-tlacitko-159-2026: Act 159/2026 Sb. of 19 Aug 2026, published in e-Sbírka
    ...
    Rescored 2026-09-21: the cap is lifted. draft_law: is removed, because taking the
    green-claims bill away leaves Why now standing on this act, so urgency now reads this
    instrument on its own at rung 3 and the score moves 8 to 10.'
  date: '2027-01-01'
...
Why now: An e-shop with no withdrawal button commits an offence from 1 January 2027, shops pay fines now, and an "eco" ban is a bill [S9,S13,S19].
...
2026-09-21 · Draft law badge removed, Why now rescored to the enacted button duty — The `draft_law:` key is gone, `scores.urgency` moves 1 → 3 and `score` moves 8 → 10, which is STRONG to PRIME on the SCORING.md bands. WHY THE BADGE CAME OFF: the template’s own test is to take the draft away and ask what Why now still stands on. Take away the green-claims bill, sněmovní tisk 53 [S13], and Why now still stands on Act 159/2026 Sb. [S19], which is passed and published — so the main pain no longer depends on an unpassed law, and the key comes out. WHY THE RUNG IS 3, limb by limb, each read off [S19]: REAL — Act 159/2026 Sb. of 19 August 2026 was published in e-Sbírka on 2 September 2026 and its § 1830a was inserted into the civil code’s general rules for distance contracts (§ 1820 ff.), not into the financial-services subsection, so it binds the seller, this record’s buyer (`entry.buyer: small-firms`), and not an authority; CLOSE — it takes effect on 1 January 2027, about three and a half months after `updated: 2026-09-19` and well inside 18 months; TEETH — Čl. I point 8 adds § 24(16)(q) and (r) to Act 634/1992 Sb., making a missing button or a missing confirmation of receipt an offence by the seller. The fine amount for those letters was not read from a consolidated text and is still not claimed. SCORES, verbatim. Before: score 8 — proof 3, money 1, urgency 1, demand 2, gap 1. After: score 10 — proof 3, money 1, urgency 3, demand 2, gap 1; only urgency moved, and 10 equals the sum of the five. PROSE MOVED WITH THE SCORE (MATCH.md §10): Why now’s answer sentence led on the fines and put the enacted duty second, which no longer matches a Why now scored at Deadline with penalties. Before, verbatim: "Why now: Shops pay fines now, every e-shop needs a withdrawal button from 1 January 2027, and an "eco" claims ban is in parliament [S9,S13,S19]." After: "Why now: An e-shop with no withdrawal button commits an offence from 1 January 2027, shops pay fines now, and an "eco" ban is a bill [S9,S13,S19]." NOTHING WAS REMOVED. The green-claims bill stays on the record as what it is, a bill: in the answer sentence above, in the Why now item that shops with "eco" badges must prove or remove them once the bill passes [S2,S13], in the paragraph on Directive (EU) 2024/825 and its dated list, which still records that until the bill passes no Czech start date for the ban is binding [S13], in first moves 1 and 2, and in `entry.why`. [S19]’s note keeps its 2026-09-19 text and gains a dated line recording that the cap it described is lifted. FLAGGED, NOT CHANGED: the title still leads on the fine a shop risks under today’s consumer law, which remains true, and the brief carries no dated duty at all, while the strongest dated fact on the record is now the 1 January 2027 button. Whether that belongs in the brief is the owner’s copy decision and was not made here. No title, brief, solution, good_for, status, source, local, comp, entry or other score changed. BRIEF REWRITTEN, same date, merged here — the copy decision the paragraph above left to the owner was taken and the dated duty is now on the card. Before, verbatim: "Inspectors caught 639 e-shops last year, usually for missing notices a shopper must see, like how to complain [S1]. Fines average about 20,000 CZK, close to what a yearly check by people costs, and no shop add-on does that check [S1,S10,S16,S17]." After, verbatim: "From 1 January 2027 every Czech e-shop must show a button for withdrawing from a contract, and a shop without one commits an offence [S19]. Inspectors caught 639 e-shops last year, with fines averaging about 20,000 CZK [S1]." WHY: the card trailed a Why now scored at Deadline with penalties by two rungs, carrying no dated duty at all. The pain stays, because the title leads on it and it is still true: the fines keep the second sentence. WHAT CAME OFF THE CARD, AND WHERE IT STILL LIVES, at 40 words there was no room for both — "usually for missing notices a shopper must see, like how to complain" is the itemised breach list in The opportunity [S1], and "close to what a yearly check by people costs, and no shop add-on does that check" is the Existing non-solutions answer sentence and its items [S10,S16], with the 18,000 CZK certificate price in Willing to pay [S17]; nothing was dropped from the record. The new first sentence reads § 1830a and § 24(16)(q) off [S19] and claims no fine amount for the new offence, which is still unread. "Fines averaging about 20,000 CZK" is our arithmetic on [S1] as before — about 13.0M CZK over 646 closed cases — and [S10,S16,S17] left the markers with the clause they backed. The title is unchanged, judged correct as it stands; the solution, good_for and every score are unchanged.
