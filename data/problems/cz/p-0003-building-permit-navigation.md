...
id: p-0003
region: cz
title: 'Czech building permits are still slow after 4 rounds of red-tape cuts'
brief: 'Whoever prepares a permit must collect opinions from several authorities and utility companies, each on its own deadline [S7]. In a 2024 survey, engineers said most permits take 6 months to a year [S5].'
solution: 'Build software for design offices that sends permit requests to authorities and utilities and tracks every answer deadline.'
good_for: 'Someone who''d like to work with building engineers and state permit systems.'
category: housing
geo: CZ-national
score: 7
scores:
