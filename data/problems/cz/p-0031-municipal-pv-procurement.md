...
No foreign analog is receipted (proof 0) and no buyer-side complaint is documented (demand 0) — the record is carried by receipted money and the freshness of the wave. It exists in the register because ~€60M a quarter of duplicated small-lot procurement is a measured, recurring inefficiency [S1]; it will re-rank if a demand receipt (SMO ČR or svazek complaints about PV procurement burden) or an aggregation-service analog appears.
