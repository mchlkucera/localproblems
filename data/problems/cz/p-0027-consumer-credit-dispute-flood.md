...
id: p-0027
region: cz
title: 'Disputes against Czech lenders have quadrupled since 2023, and every one needs someone to answer it'
...
draft_law: 'Czech consumer-credit bill for the new EU rules, not yet passed [S6,S10]'
...
- type: regulation
  ...
  note: 'reg-adr-spotrebitelske-spory-2028 (reg-scan, 2026-09-18), linked in MATCH 2026-09-18.
    ...
    Rescored 2026-09-19: the deadline sub-score is retired. On the 2026-09-19 ladder this fails
    REAL (a plan item on the Czech side) and CLOSE (20 Sep 2028 is more than 18 months after
    updated), so it backs urgency 1 at most; S9 no longer carries a higher point either.'
  date: '2028-09-01'
...
- type: regulation
  ...
  note: 'reg-ccd2-consumer-credit (ledger signal, not new this run), linked in MATCH 2026-09-18
    ...
    Rescored 2026-09-19: the deadline sub-score is retired, and "goes 0 to 2" no longer holds.
    On the 2026-09-19 ladder a directive awaiting transposition fails REAL: the Czech bill (S10)
    has not passed, so nothing yet binds a Czech lender on 20 Nov 2026. It backs urgency 1.'
  date: '2026-11-20'
...
- 15,446 cases were in progress at some point in 2025, 14,235 of them about consumer loans [S1].
- New loan cases alone rose from 2,097 in 2023 to 11,386 in 2025 [S1].
...
Why now: Lenders already answer bulk claims one at a time, and the rule widening the repayment check from November 2026 is not yet Czech law [S1,S10].
...
- So neither date binds a Czech lender yet: the first waits on that bill, and the second is two years away and only planned [S8,S10].
...
1. Contact the head of legal at one non-bank lender and shadow its arbiter cases for a week, counting the lawyer hours each case burns. Consumer credit is almost all of the arbiter's caseload, and each case is answered by hand; see [The opportunity](#opportunity) and [Market gap](#competition). The hours you count are what your software saves, so price against them. Start with non-bank lenders, because a Czech firm already markets this work to them, which shows they are the ones looking for help; see [Willing to pay](#willing-to-pay).
2. Build the settlement call first: a tool that tells a lender, from the loan file, whether a case is worth fighting or settling. Most concluded cases settle, so that is the decision a lender actually makes; see [Why now](#why-now). Then add a deadline clock on each proceeding and the answer pack assembled from the loan file. No Czech product was found doing any of the three; see [Market gap](#competition).
...
2026-09-19 · title corrected (owner-approved), one body figure corrected — Title before, verbatim: "Czech lenders pay lawyers by the hour to answer loan complaints that have quadrupled since 2023". After: "Czech lenders faced over 14,000 loan disputes at the state arbiter last year. New ones have more than quadrupled since 2023." Why: no source on file says lenders pay lawyers by the hour; [S4]'s note records only law firms handling cases by hand, and the 2026-09-18 entry had left the phrase to the owner. The new title is built on the caseload the arbiter's 2025 report documents, re-read at [S1]'s URL on this date: "Celkově v roce 2025 před finančním arbitrem probíhalo 15.446 řízení, z toho 14.235" about consumer credit, so over 14,000 loan disputes were in progress during 2025 [S1]; and new consumer-credit cases went from 2,097 in 2023 to 11,386 in 2025, 5.4 times, while all new cases went from 2,660 to 12,050, 4.5 times [S1], so "more than quadrupled" holds on either count. Corrected in the body against the same page: "15,446 cases were running when the 2025 report came out [S1]" misread "probíhalo v roce 2025", which counts every case in progress at some point during 2025, not the cases still open on one date; it now reads "15,446 cases were in progress at some point in 2025, 14,235 of them about consumer loans [S1]", and a new bullet carries the loan-only growth from 2,097 to 11,386 [S1]. Both figures are on [S1]'s page but not in its note, which was not edited. "Lenders faced" rests on consumer credit being the lender's side of these disputes; the arbiter's count does not split banks from non-bank lenders. No score, status, source, note, marker, brief, solution or good_for changed. Same date, later pass, merged here: rescored to the 2026-09-19 ladders, and the owner-approved title applied. Title before, verbatim: "Czech lenders faced over 14,000 loan disputes at the state arbiter last year. New ones have more than quadrupled since 2023." After: "Disputes against Czech lenders have quadrupled since 2023, and every one needs someone to answer it". Checked against the sources before it was written, and no word needed a fix. "Quadrupled since 2023" is the arbiter's count: new consumer-credit cases went from 2,097 in 2023 to 11,386 in 2025, 5.4 times, and all new cases from 2,660 to 12,050, 4.5 times [S1], so it holds on either count and, if anything, understates the loan count. "Against Czech lenders" rests on those being consumer-credit cases, where the lender is the other party [S1]. "Every one needs someone to answer it" rests on the arbiter's own FAQ at [S4]'s URL, re-read on this date: before filing, a borrower must write to the lender demanding a remedy and give it time to respond ("poskytnout přiměřenou lhůtu k vyjádření na výzvu, doporučujeme alespoň 10 dní"), and the filing encloses that demand and any refusal, so every case is first put to the lender for an answer; that each one then needs answering in the proceeding is our plain reading of the procedure, already flagged on 2026-09-18, and the owner approved the wording as such. Tagging pass: every source on file was read for someone paying for this job, case software that answers arbiter disputes for a lender, or its manual equivalent bought in, and none is. The one Czech firm selling the work as a service to non-bank lenders publishes no price [S5,S7], the law firms working cases by hand state no fee [S4], and the arbiter's own case-handling contracts, which `price_search:` points to, buy for the arbiter, not for the lender. `scores.money` stays 0. `scores.urgency` 3 → 1: the freshness point is retired; the EU consumer-credit directive [S9] applies from 20 November 2026 but is not yet Czech law, since the Czech bill [S10] has not passed, so it fails REAL; the arbiter-law change [S8] is only planned in Czechia and its 20 September 2028 date is more than 18 months out; the Consumer Credit Act revision [S6] backs no score; and the repayment-check duty in force since 2016 is the status quo. `score` 9 → 7, STRONG → FAIR. The notes on S8 and S9 named the retired deadline sub-score and gained a dated rescore line; their original text is left as written. Three `[Competition](#competition)` links now read `[Market gap](#competition)`. Prose re-read against the new numbers. Why now's answer was "Lenders already answer bulk claims one at a time, and from 20 November 2026 the repayment check those claims turn on covers more loans [S1,S9]." and now reads "Lenders already answer bulk claims one at a time, and the rule widening the repayment check from November 2026 is not yet Czech law [S1,S10].", because the old sentence stated a Czech date the bill has not yet made binding; a bullet now says neither date binds a Czech lender yet [S8,S10]. Willing to pay already says no buyer or price is public [S1,S5] and stands. FLAGGED for the owner, as the worksheet did: the main trigger is a bill and the record carries no `draft_law:`, so the page's rung-1 reason line reads "far off or binding someone else" rather than "not law yet". No other score, status, source order, marker, brief, solution or good_for changed.

2026-09-19 · Draft law badge added (owner-approved) — `draft_law:` added: "Czech consumer-credit bill for the new EU rules, not yet passed [S6,S10]". Why: Why now scores 1 on bills alone. The EU consumer-credit directive [S9] applies from 20 November 2026, but it reaches a Czech lender only through the finance ministry's amendment of the Consumer Credit Act. That bill has been a draft on the government's legislative portal since 14 February 2025 [S6], predates the October 2025 election and still has to pass [S10]. The arbiter-law change for 2028 is only planned [S8], and the repayment-check duty in force since 2016 is the status quo. Without the key, the page's rung-1 reason read "far off or binding someone else" instead of "not law yet"; the rescore entry above flagged this, and the owner decided on 2026-09-19 that the badge goes on. Both markers are `type: regulation`, as the gate requires, and name the same bill: [S6] its draft on the portal, [S10] its stage and effective date. The status is as those sources state it; no new check of the bill's progress was run in this pass. FLAGGED for the owner: the caseload itself is today's pain and stands whatever the bill does [S1], which is the case RECORD-TEMPLATE.md's `draft_law:` section says to leave the key off for. The badge here marks the Why now trigger, the same call made the same day on p-0028. Urgency 1 is consistent with the badge: a record with `draft_law:` stops at 1 (SCORING.md URGENCY). No `locals[]` row changed: all ten were already `competes: adjacent`, and gap stays 2. No score, status, source, note, marker target, headline field or body sentence changed.
