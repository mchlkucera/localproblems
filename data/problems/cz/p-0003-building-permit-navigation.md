...
Solved elsewhere: PermitPortal (YC F24), Permitify (YC W25) and Verdant (YC S26) show a funded US cluster around AI permit/zoning navigation [S1]. All analogs are US-based [S1,S4] and permitting is jurisdiction-specific; with the local field occupied [S7], documented demand is now what carries this record.
