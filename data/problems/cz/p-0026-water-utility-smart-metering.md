...
---
**CORRECTION (2026-08-20, evidence audit):** The "Why now" sentence has been removed in full. It carried three claims, none of which has any support in the 6,181-signal corpus. (1) **"price regulation via ERSO oversight"** — `ERSO` returns zero hits corpus-wide, case-sensitively and case-insensitively, and no Czech water-price regulator appears anywhere in the evidence. There is no such body: the Czech energy regulator is ERÚ, and it does not regulate water. No substitute name has been inserted, because we hold no receipt for one. (2) **"EU funding streams (OPŽP) co-finance the projects"** — eleven OPŽP calls are on file and none of them funds metering; they fund public-building energy retrofits, renewables, landscape and water-landscape measures, rain/greywater capture, slope stability, flood prevention, contaminated-site remediation, food banks and air-quality monitoring. (3) The **drought and water-loss driver** is likewise uncited. The money score is untouched: it never rested on OPŽP but on the receipted tenders and contracts already on this ledger [S1,S2,S3,S4,S5].
