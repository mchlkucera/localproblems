...
id: p-0025
region: cz
title: 'Insulating a Czech house is a patchwork of firms, quotes and paid paperwork'
brief: 'The roof often goes to one firm and the walls to another, each surveying and pricing the house [S7]. Then comes the energy assessment and subsidy application, which a homeowner can pay a firm to handle [S9].'
solution: 'Build an insulation company whose own crews insulate the whole house at one fixed price and handle the subsidy, as 3 companies already do in Germany.'
good_for: 'Someone who can run building crews and handle state subsidy paperwork.'
category: energy
geo: CZ-national
score: 5
scores:
...
- type: subsidy
  ...
  note: Nová zelená úsporám funds zateplení (insulation) alongside heat pumps/PV — the standing
    ...
    Rescored 2026-09-19. The retired rung above no longer applies. On the 2026-09-19 ladder this
    is public money nearby and earns no point alone. It lifts the S9 asking price to money 2,
    because every lift condition is on file. It names homeowners, who are households and so
    inside entry.buyer small-firms (CONVENTIONS.md), it funds insulation, it is a standing
    programme open on updated, and it co-pays only part of the ticket.
  date: '2026-08-13'
- type: gap-check
...
- type: regulation
  ...
  note: 'reg-epbd-recast: EPBD recast (2024/1275) — transposition overdue since May 2026,
    ...
    ladder an untransposed directive that binds member states fails REAL, and its residential
    dates, 2030 and 2033, fail CLOSE, so this backs urgency 1.'
  date: '2026-07-15'
...
- type: price
  ...
  note: 'Price receipt lifted from the 2026-08-20 deeper sweep already on this ledger, which
    ...
    schválení dotace.
    Rescored 2026-09-19: now tagged dims: [money]. The deposit buys the survey, energy
    assessment and subsidy handling, the paperwork half of the whole-house job the solution
    sells, bought by a homeowner: an ASKING receipt (list-price), money 1, lifted to 2 by the
    subsidy in S2.'
  date: '2026-08-20'
  dims: [money]
  ...
  basis: list-price
- type: subsidy
  name: "SFŽP call 1/2026/NZU FN — zero-interest renovation loans"
  gist: "the zero-interest subsidy loans"
  why: "From 16 September 2026 banks can lend holders of a state renovation subsidy decision money on which the borrower pays no interest or fees, and the state environment fund compensates the bank. Up to 50bn CZK of such loans can be signed by the end of 2031, for family houses and for apartment-owner associations and housing cooperatives."
  url: https://sfzp.gov.cz/dotace-a-pujcky/financni-nastroje-a-pujcky/vyzva-1-2026-nzu-fn/
  note: 'dotace-sfzp-1-2026-nzu-fn-kompenzace (dotace-scan, 2026-09-18), linked in MATCH
    2026-09-18. SFŽP call 1/2026/NZU FN, published 16 Sep 2026: credit institutions sign up to
    lend Nová zelená úsporám renovation loans with no interest or fees for the borrower; SFŽP
    pays the bank PRIBOR 1M (floored at 0) plus a margin of 0.90 % (unsecured family-house
    loans), 0.50 % (secured family-house loans) or 0.40 % (SVJ/BD loans). Final beneficiary: the
    holder of an NZÚ support decision. Allocation: up to 50bn CZK of LOAN VOLUME contracted 16
    Sep 2026 to 31 Dec 2031; the compensation outlay itself is not published. WHY MONEY STAYS
    1: the only published figure is loan volume, not public money, and the public money is an
    interest subsidy to banks, one step further from the job than the grant in S2 that set money
    1. It is cited as money nearby, and it moves no rung. It replaces the earlier interest-free
    NZÚ loan instrument (HOUSEnerg 1/2024 FN), which the scan found closed.
    Rescored 2026-09-19: "why money stays 1" reasons on the retired ladder. On the 2026-09-19
    ladder this is public money nearby: it pays banks an interest subsidy, not the job, so it is
    not the lift. The lift to money 2 is S2 on top of the S9 price.'
  date: '2031-12-31'
...
The subsidy is Nová zelená úsporám ("New Green Savings"), which co-pays insulation alongside heat pumps and solar panels [S2]. Because it is a standing programme, households already apply for this work [S2]. One national installer stands out from the small firms; see [Market gap](#competition) [S7].
...
- Until Czech law sets them, no date binds a homeowner, so nothing yet forces the work by a given day [S5].
...
Since 16 September 2026 a homeowner holding a subsidy decision can also borrow for the work at no interest or fees, and the state environment fund pays the bank's interest [S10]. Up to 50bn CZK of these loans can be signed by the end of 2031 [S10].
