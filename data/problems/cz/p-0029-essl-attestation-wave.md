...
- type: contract
  ...
  dims: []
- type: ask
  url: https://nen.nipez.cz/verejne-zakazky/detail-zakazky/N006-26-P00000211
  name: "NEN — the land-survey office plans a new certified records system"
  gist: "90 million records to move"
  why: "The state land-survey and cadastre office announced it will tender a new certified records system, including moving about 90 million records from its current one, and asked suppliers for input by 15 October 2026."
  note: 'nenptk-n006-26-p00000211: Český úřad zeměměřický a katastrální, předběžná tržní konzultace
    (§33 ZZVZ) "Zajištění nového atestovaného elektronického systému spisové služby", published on
    NEN 9 Sep 2026, information due 15 Oct 2026, CPV 72262000-9. NEN page read 2026-09-19: the
    planned contract is delivery of a new attested eSSL "včetně zajištění s tím související migrace
    dat ze stávající elektronické služby (cca 90 milionů záznamů á 20 atributů)", user training, an
    analysis of how the office runs its records service and setting it in line with the law, plus
    technical support after delivery. No value stated. It names moving the old records as part of
    the purchase before any tender is out. An ask cites DEMAND ONLY (MATCH.md §11): a single named
    public body stating it has this job is demand rung 1. It is not a price and not a tender award,
    so it backs no money point (S10 and S11 carry money), and it says nothing about gap. The page
    does not say whether the current system is attested, so that is not claimed.'
  date: '2026-09-09'
  signal: nenptk-n006-26-p00000211
  dims: [demand]
created: '2026-08-13'
updated: '2026-09-19'
---
...
So the certificate is scarce, not the software [S8]. The demand on record is the tenders and one named body's plan: the state land-survey office says it needs a new certified system and a move of about 90 million records [S2,S13]. No public body's complaint has been found, and no source counts how many still run an uncertified system [S2].
...
- The state land-survey and cadastre office plans a tender for a new certified system that includes moving about 90 million records from its current one [S13]. It asked suppliers for input by 15 October 2026 and states no value [S13].
