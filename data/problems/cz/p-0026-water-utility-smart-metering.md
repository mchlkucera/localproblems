...
id: p-0026
region: cz
title: 'Czech water utilities each buy smart meters on their own'
brief: 'Czechia has hundreds of water utilities, and those fitting smart meters buy the meters, radio readers and software alone [S2]. This summer 7 signed or tendered separate deals [S2,S5].'
solution: 'Build a service that fits smart meters for small water utilities and reads them remotely, as Czech firms already do.'
...
- type: price
  ...
  basis: signed-contract
- type: tender
  name: "TED — Ivančice closes its smart-metering tender with no winner"
  gist: "four bids, no winner"
  why: "The Ivančice water association's result notice for the smart-metering tender opened in June: four bids came in, and the tender closed without a winner."
  url: https://ted.europa.eu/en/notice/-/detail/643326-2026
  note: 'ted-643326-2026, TED result notice published 18 Sep 2026 (dispatched 16 Sep), XML read
    2026-09-19: Svazek vodovodů a kanalizací Ivančice (IČO 49458892), "Instalace Smart Meteringu na
    vodovodní síti – SVaK Ivančice", the procedure S1 cites (ted-430180-2026), estimated
    28,920,673 CZK; scope "dodávku systému Smart Meteringu včetně instalace 12 031 ks odečtového
    zařízení" incl. online reading, data transfer and evaluation, installation, maintenance and
    operation. winner-selection-status clos-nw (no winner chosen, competition closed), 4 tenders
    received, non-award code "other"; the notice gives no reason in words. Not awarded, so not a
    price receipt; backs no score.'
  date: '2026-09-16'
  signal: ted-643326-2026
  dims: []
- type: tender
  name: "TED — Ivančice closes its meter tender with no winner"
  gist: "7,501 meters, no winner"
  why: "The same water association's separate tender for 7,501 water meters ready for remote reading also closed without a winner, after three bids."
  url: https://ted.europa.eu/en/notice/-/detail/645454-2026
  note: 'ted-645454-2026, TED result notice published 18 Sep 2026 (dispatched 16 Sep), XML read
    2026-09-19: SVaK Ivančice, "Instalace Smart Meteringu na vodovodní síti – SVaK Ivančice – nákup
    mechanických vodoměrů", first notified as ted-478517-2026 (10 Jul 2026); "dodávka 7 501 ks
    mechanických vodoměrů", DN 20, "vybaveny pulsním výstupem pro montáž dálkového odečtu",
    estimated 8,200,000 CZK, no EU funds. winner-selection-status clos-nw, 3 tenders received,
    non-award code tch-pr-error; no reason in words. Not awarded; backs no score.'
  date: '2026-09-16'
  signal: ted-645454-2026
  dims: []
created: '2026-08-13'
updated: '2026-09-19'
---
...
- In September 2026 Ivančice closed that competition without a winner, after four bids [S13]. Its separate tender for 7,501 meters ready for remote reading closed the same way, after three [S14].
